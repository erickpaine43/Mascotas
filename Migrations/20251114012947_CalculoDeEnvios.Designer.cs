...
namespace Mascotas.Migrations
{
    ...
    [Migration("20251114012947_CalculoDeEnvios")]
    partial class CalculoDeEnvios
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mascotas.Models.MetodoEnvio", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Mascotas.Models.ZonaEnvio", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("CostoPorKiloExtra")
                        .HasPrecision(10, 2)
                        .HasColumnType("decimal(10,2)");

                    b.Property<int>("DiasEstandar")
                        .HasColumnType("int");

                    b.Property<int>("DiasExpress")
                        .HasColumnType("int");

                    b.Property<decimal>("MontoMinimoEnvioGratis")
                        .HasPrecision(10, 2)
                        .HasColumnType("decimal(10,2)");
                    ...
                    b.Property<string>("RangoCodigosPostales")
                        .HasColumnType("nvarchar(max)");

                    b.Property<decimal>("RecargoFragil")
                        .HasPrecision(10, 2)
                        .HasColumnType("decimal(10,2)");

                    b.Property<decimal>("TarifaBaseEstandar")
                        .HasPrecision(10, 2)
                        .HasColumnType("decimal(10,2)");

                    b.Property<decimal>("TarifaBaseExpress")
                        .HasPrecision(10, 2)
                        .HasColumnType("decimal(10,2)");

                    b.HasKey("Id");

                    b.ToTable("ZonaEnvios");
                });
            ...
            modelBuilder.Entity("Mascotas.Models.Orden", b =>
                {
                    ...
                    b.HasOne("Mascotas.Models.Direccion", "DireccionEnvio")
                        .WithMany()
                        .HasForeignKey("DireccionEnvioId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Mascotas.Models.MetodoEnvio", "MetodoEnvio")
                        .WithMany()
